...
const AvatarPage: React.FC = () => {
    const characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ123@#'.split('');
        ...
        <div>
            ...
            <div className={styles.container}>
                <div className={styles.card}>
                    ...
                    <div className={styles.inner_card}>
                        <Avatar size="xs" imageIndex={0} />
                        <Avatar size="sm" imageIndex={1} />
                        <Avatar size="lg" imageIndex={2} />
                        <Avatar size="xl" imageIndex={3} />
                        <Avatar size="2xl" imageIndex={4} />
                        <Avatar size="3xl" imageIndex={0} />
                        <Avatar size="4xl" imageIndex={5} />
                    </div>
                </div>
            </div>
            {/* Variant */}
            <div className={styles.container}>
                <div className={styles.card}>
                    ...
                    <div className={styles.inner_card}>
                        ...
                        <Avatar size="md" bgColor='#00a76f' variant="runded">
                            <svg
                        ...
                        <Avatar size="md" bgColor='#00a76f' variant="square" >
                            <svg
                            ...
                            <div className={styles.inner_card}>
                                {characters.map((char, index) => (
                                    <Avatar
                                        ...
                                        variant="full"
                                        size="md" // اندازه بزرگ‌تر برای A-Z، کوچک‌تر برای 1@#
                                        colorIndex={index} // اندیس برای انتخاب رنگ
                                    >
                                        {char}
                                    </Avatar>
                                ))}
